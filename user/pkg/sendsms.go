...
func SendSms(mobile, code string) (T, error) {

	sms := configs.Conf.SendSms

	v := url.Values{}
	v.Set("account", sms.Account)                      //APIID（用户中心【文本短信】-【验证码/通知短信】-【产品总览】查看）
	v.Set("password", sms.Password)                    //1、APIKEY（用户中心【文本短信】-【验证码/通知短信】-【产品总览】查看）2、动态密码（生成动态密码方式请看该文档末尾的说明）
